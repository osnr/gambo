...
public class Rom {
	...
	public final static int ENTRY_LENGTH = 0x104 - 0x0100;
	public final static int LOGO_LENGTH = 0x0134 - 0x104;
	public final static int TITLE_LENGTH = 0x0144 - 0x0134;
	public final static int NEW_LICENSEE_CODE_LENGTH = 0x0146 - 0x0144;
	public final static int GLOBAL_CHECKSUM_LENGTH = 0x0150 - 0x014E;
